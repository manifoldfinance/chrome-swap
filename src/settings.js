...
document.addEventListener('DOMContentLoaded', function () {
  ...
  chrome.tabs.query({ active: true, currentWindow: true }, (tabs) => {
    chrome.tabs.executeScript(tabs[0].id, { code: 'localStorage[\'__web3connectAppearAsMM__\']' }, (results) => {
      ...
      if (mmAppear) {
        toggle.innerHTML = '<span>Appear As <span class=\'frame\'> Web3Connect </span> Instead </span>'
        ...
        injecting.innerHTML = '<span>Injecting as <span class=\'frame\'>Web3Connect</span> </span>'
      }
