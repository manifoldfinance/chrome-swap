...
let mmAppear = window.localStorage.getItem('__web3connectAppearAsMM__')
...
if (mmAppear) {
  ...
  try {
    ...
    console.error('Web3Connect MetaMask Error:', e)
  }
} else {
  class Web3ConnectProvider extends EthereumProvider {}


  try {
    window.ethereum = new Web3ConnectProvider(new Connection())
